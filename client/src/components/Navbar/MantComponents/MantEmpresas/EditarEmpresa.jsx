...
function EditarEmpresa() {
    ...
    const onSubmit = async (e) => {
        ...
        setTelefonos([])
        setCorreos([''])
        console.log("despues de modificar" + nombre, ubicacion, telefonos, correos)
        evaluate()
        } catch (error) {
        setIsError(true)
    ...
    <div className="containerMantenimiento" style={{userSelect: "none"}}>
        ...
        <div className="frow">
            ...
            <div className="fcolumn">
                ...
                <div className="frow">
                    <input type="text" id="buscar" placeholder="nombre de la empresa" autoComplete="off" style={{width:'250px'}} value={nombre} onChange={event => {setNombre(event.target.value)}} onClick={evaluate}/>
                                    ...
                                    {telefonos.map((data, index) => {
                                        return(
                                            ...
                                            <div className="frow">
                                                ...
                                                <input type="number" key={index} value={data} onChange={(evnt) => handleChangeTelefonos(index, evnt)} required={true} autoComplete="off" name="telefono" placeholder="teléfono"/>
