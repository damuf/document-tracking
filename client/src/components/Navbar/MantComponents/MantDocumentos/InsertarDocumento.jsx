    ...
    <div className="containerMantenimiento" style={{userSelect: "none"}}>
      ...
      <div className="frow">
        ...
        <div id="form" className="fcolumn">
          <h2 style={{textShadow: 'red -2px 0, cyan 2px 0'}}>Añadir un nuevo documento</h2>
          <form id="crearEmpresas" method="get" onSubmit={onSubmit}>
            <div className="frow">
              <i className="material-symbols-outlined">work</i> &nbsp;
              <input type="text" id="numCaso" placeholder="código caso" required={true} autoComplete="off" value={numCaso} onChange={event => {setNumCaso(event.target.value)}}/>
            </div>
            <br />

            <div className="frow">
              <i className="material-symbols-outlined">apartment</i> &nbsp;
              <input type="text" id="nomTramite" placeholder="nombre tramite" required={true} autoComplete="off" value={nomTramite} onChange={event => {setNomTramite(event.target.value)}}/>
            </div>
            <br />

            <div className="frow">
              <i className="material-symbols-outlined">description</i> &nbsp;
              <input type="text" id="nombre" placeholder="nombre documento" required={true} autoComplete="off" value={nombre} onChange={event => {setNombre(event.target.value)}}/>
            </div>
            <br />
            <div className="frow">
              <i className="material-symbols-outlined">share_location</i> &nbsp;
              <input type="text" id="medio" placeholder="medio" required={true} autoComplete="off" value={medio} onChange={event => {setMedio(event.target.value)}} />
            </div>
            <br />
            <div className="frow">
              <i className="material-symbols-outlined">folder</i> &nbsp;
              <input type="file" className="" id="" placeholder="ruta" required={true} autoComplete="off" value={ruta} onChange={event => {setRuta(event.target.value)}} style={{}} />
            </div>
            <br />
            <div className="frow">
